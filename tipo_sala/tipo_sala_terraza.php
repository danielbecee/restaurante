...
<!-- Contenido principal -->
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="../img/terraza_este.jpg" class="card-img-top" alt="Terraza Este">
                    <div class="card-body">
                        <h5 class="card-title">Terraza Este</h5>
                        <a href="terraza_este.php" class="btn btn-primary">Acceder</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="../img/terraza_oeste.jpg" class="card-img-top" alt="Terraza Oeste">
                    <div class="card-body">
                        <h5 class="card-title">Terraza Oeste</h5>
                        <a href="terraza_oeste.php" class="btn btn-primary">Acceder</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="../img/terraza_sud.jpg" class="card-img-top" alt="Terraza Sud">
                    <div class="card-body">
                        <h5 class="card-title">Terraza Sud</h5>
                        <a href="terraza_sud.php" class="btn btn-primary">Acceder</a>
                    </div>
                </div>
            </div>
        </div>
