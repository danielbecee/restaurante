...
<div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="../img/comedor_este.jpg" class="card-img-top" alt="comedor Este">
                <div class="card-body">
                    <h5 class="card-title">Comedor Este</h5>
                    <a href="comedor_este.php" class="btn btn-primary">Acceder</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="../img/comedor_oeste.jpg" class="card-img-top" alt="comedor Oeste">
                <div class="card-body">
                    <h5 class="card-title">Comedor Oeste</h5>
                    <a href="comedor_oeste.php" class="btn btn-primary">Acceder</a>
                </div>
            </div>
        </div>
