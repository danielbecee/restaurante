    ...
    if (isset($_POST['mesa_id']) && isset($_POST['estado'])) {
        ...
        if ($estado === 'libre' || $estado === 'ocupada') {
            ...
            if ($rowEstado) {
                ...
                header("Location: terraza_oeste.php?status=success");
                exit;
            } else {
...
try {
    ...
    $sql = "
        ...
        WHERE s.tipo_sala = 'Terraza Oeste'
    ";
...
<a href="./tipo_sala_terraza.php" class="btn btn-secondary btn-sm">Volver</a>
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <form action="terraza_oeste.php" method="POST">
